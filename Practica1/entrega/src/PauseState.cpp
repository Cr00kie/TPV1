    ...
    : GameState(g), m_pPlayState(playState)
{
    Button* contin = new Button(this, m_pGame->getTexture(SDLApplication::CONTINUAR), {
                          ...
                          (float)(CONT_BUT_POS - m_pGame->getTexture(SDLApplication::CONTINUAR)->getFrameHeight())
        }
    );
    addObject(contin);
    ...
    Button* restart = new Button(this, m_pGame->getTexture(SDLApplication::REINICIAR), {
                          ...
                          (float)(REST_BUT_POS - m_pGame->getTexture(SDLApplication::REINICIAR)->getFrameHeight())
        }
    );
    addObject(restart);
